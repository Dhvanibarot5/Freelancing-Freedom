      ...
      <div className="flex justify-between items-start">
        <div className="space-y-2">
          ...
          <span
            ...
            ${project.status === "Active" ? "bg-blue-100 text-blue-700" : "bg-green-100 text-green-700"}`}
          >
            {project.status}
          </span>
          {project.payment && <p className="text-sm font-medium text-gray-700">Payment: ${project.payment}</p>}
        </div>
        <button onClick={handleDelete} className="text-red-500 hover:text-red-700 p-2 hover:bg-red-50 rounded-full transition-colors duration-200">
